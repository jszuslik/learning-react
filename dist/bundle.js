...
var Header = exports.Header = function (_React$Component) {
    ...
    _createClass(Header, [{
        ...
        value: function getTitle() {
            var n = Math.round(this.props.title.length / 2);
            console.log(Math.round(n / 2));
            var first = this.props.title.substr(0, n);
            var second = this.props.title.substr(n);
            return _react2.default.createElement(
                'h1',
        ...
        get: function get() {
            return {
                ...
                menu_icon: _propTypes2.default.string
            };
        }
    }, {
        key: 'defaultProps',
